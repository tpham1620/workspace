 ...
 *      Author: Tan Pham
 *  This file create a private heap (pool) and manage this pool my my_malloc and my_free functions
 */
...
/*
 * my_malloc function
 * return a void pointer to a part of memory in the pool where it available
 * return NULL if no more space available.
 */
...
/*
 * my_free function
 * set the pass in block free and make it available for the next request
 * if two or more block is free and next to each other, join them together.
 */
